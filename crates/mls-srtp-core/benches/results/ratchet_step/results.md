...
- **Chip**: Apple M2 (8 physical cores, 4 performance + 4 efficiency)
- **RAM**: 16 GB
...
stream. This is overkill when only the key bytes differ, as in our case. Concretely, the steps we skip are: reallocating the cipher object (a field of the
