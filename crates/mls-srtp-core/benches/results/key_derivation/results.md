...
| Operation                                    | Latency  |
|----------------------------------------------|----------|
| 4 x AES-128-CTR keystream (RFC 3711 §4.3.1)  | 887 ns   |
...
| Operation              | Latency  |
|------------------------|----------|
| export + KDF combined  | 5.03 µs  |

The MLS exporter dominates at ~80% of the total cost. At 5.03 µs per
epoch change, key derivation is negligible compared to the MLS commit
processing that triggers it (257 µs for a 2-member group).
